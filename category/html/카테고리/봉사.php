...
<html lang="en">
  ...
  <ul class="right-ul">
   ...
   data: {
      currentFilter: '전체',
      projects: [
	  	  {title: "개구장이", image: "../../봉사/레저/인하라이더.jpg", category: '아동봉사'},
        {title: "파파", image: "../../봉사/레저/인하라이더.jpg", category: '아동봉사'},
        {title: "MRA", image: "../../봉사/레저/인하라이더.jpg", category: '아동봉사'},
        {title: "인하브로드", image: "../../봉사/레저/인하라이더.jpg", category: '아동봉사'},
        {title: "하룡회", image: "../../봉사/레저/인하라이더.jpg", category: '아동봉사'},
        {title: "사랑해줄개", image: "../../봉사/레저/인하라이더.jpg", category: '유기봉사'},
        {title: "심성회", image: "../../봉사/레저/인하라이더.jpg", category: '복지관'},
        {title: "아해누리", image: "../../봉사/레저/인하라이더.jpg", category: '복지관'},
        {title: "트인", image: "../../봉사/레저/인하라이더.jpg", category: '집수리'},
        {title: "로타랙트", image: "../../봉사/레저/인하라이더.jpg", category: '기타'},
        {title: "용마루", image: "../../봉사/레저/인하라이더.jpg", category: '기타'},
        {title: "대우회/JOA", image: "../../봉사/레저/인하라이더.jpg", category: '기타'},
        {title: "RCY", image: "../../봉사/레저/인하라이더.jpg", category: '기타'},
      ]
   },
   methods: {
